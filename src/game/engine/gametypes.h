...
enum ThreatType
{
    ...
    THREAT_AIRCRAFT = 0x4,
    THREAT_INFANTRY = 0x8,
    THREAT_VEHICLES = 0x10,
    THREAT_BUILDINGS = 0x20,
    THREAT_ECONOMY = 0x40,
    THREAT_VESSELS = 0x80,
    THREAT_NEUTRAL = 0x100,
    THREAT_INFILTRATION = 0x200,
    THREAT_FAKE_BUILDINGS = 0x400,
    THREAT_POWER_FACILTIES = 0x800,
    THREAT_FACTORIES = 0x1000,
    THREAT_BASE_DEFENSES = 0x2000,
    THREAT_3D60 = (THREAT_BASE_DEFENSES | THREAT_FACTORIES | THREAT_POWER_FACILTIES | THREAT_FAKE_BUILDINGS | THREAT_NEUTRAL
        | THREAT_ECONOMY | THREAT_BUILDINGS), // 0x3D60
    THREAT_3DF8 = (THREAT_3D60 | THREAT_VESSELS | THREAT_VEHICLES | THREAT_INFANTRY) // 0x3DF8
};

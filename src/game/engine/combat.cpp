...
void Wide_Area_Damage(coord_t coord, unsigned short shortval, int damage, TechnoClass *object, WarheadType warhead)
{
#ifdef GAME_DLL
    DEFINE_CALL(func, 0x004A37D4, void, coord_t, unsigned short, int, TechnoClass *, WarheadType);
